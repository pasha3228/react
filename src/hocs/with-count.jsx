...
export function withCount(WrappedComponent) {
  const WithCount = (props) => {
    ...
    return <WrappedComponent {...props} count={count} decrement={decrement} increment={increment} />
  }

  WithCount.display = `WithCount${WrappedComponent.displayName || WrappedComponent.name || ""}`
